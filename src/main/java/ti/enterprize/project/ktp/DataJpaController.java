 ...
 */
package ti.enterprize.project.ktp;
...
import ti.enterprize.project.ktp.exceptions.NonexistentEntityException;
import ti.enterprize.project.ktp.exceptions.PreexistingEntityException;
...
public class DataJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("ti.enterprize_project.ktp_jar_0.0.1-SNAPSHOTPU");
